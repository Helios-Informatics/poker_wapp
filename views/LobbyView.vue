...
<template>
  <body class="body">
    <div class="h-90 w-100 d-flex flex-row px-4 mt-5">
      ...
      <div class="h-100 w-50 d-flex flex-column align-content-center">
        ...
        <div class="form-group mt-3 w-50">
          <label for="smallBlind" class="form-label text-white"
            >Small Blind</label
          >
          <input
            v-model="smallBlind"
    ...
    <div
      class="fixed-bottom w-100 h-10 d-flex flex-row justify-content-end align-items-end mb-5 pe-5"
    >
      <button type="button" class="btn btn-primary me-2" @click="copyLobbyLink">
        Copy Invite Link
      </button>
      <button type="button" class="btn btn-success" @click="newGame">
        Start Game
      </button>
    </div>
  </body>
