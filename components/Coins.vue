...
import { calculateCoinsData } from "../scripts/utils.js";
...
const coins2 = computed(() => calculateCoinsData(amount.value));
</script>
...
<template>
  <div class="stack-amount-container bg-transparent">
    <div class="coin-stack">
      <div
        v-for="(coin, index) in coins2"
        :key="index"
        class="coin"
        :style="{ top: `${index * -5}px` }"
      >
        <svg
          class="responsive-coins"
          viewBox="0 0 281 281"
          :fill="coin.fillColor"
          xmlns="http://www.w3.org/2000/svg"
        >
          <g filter="url(#filter0_d_64_21)">
            <circle cx="132.5" cy="132.5" r="128.5" :fill="coin.fillColor" />
          </g>
          <path
          ...
          <defs>
            ...
            >
              ...
              <feMorphology
                ...
                operator="dilate"
                in="SourceAlpha"
                result="effect1_dropShadow_64_21"
              />
              <feOffset dx="8" dy="8" />
