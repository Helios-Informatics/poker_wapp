...
import { calculateCoinsHtml } from "../scripts/utils.js";

const props = defineProps({
  amount: Number,
});

const coins2 = computed(() => calculateCoinsHtml(props.amount));
</script>
<template>
  <div class="stack-amount-container bg-transparent">
    <div class="coin-stack">
      <div v-for="([outlineColor, fillColor], index) in coins2" :key="index" class="coin"
